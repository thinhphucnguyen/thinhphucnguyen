...
**Pokemon RPG on BeagleBone**

Full-featured game with battle systems, animations, and PvP multiplayer running on embedded hardware. Qt/C++ from scratch.

</td>
<td width="50%">

**Multi-Drone Exploration with RL**

Autonomous drones learning to explore and navigate unknown environments collaboratively using reinforcement learning.
...
Deconvolution, PSF analysis, and inverse problems in optical systems.
